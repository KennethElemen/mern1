    ...
    <div className="modal-dialog custom-modal-width">
        <div className="modal-content">
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md w-full">
                ...
                <div className="w-full border-1 border-gray-400 h-px mt-6"></div>
                <div className="mt-4 flex justify-end space-x-4">
                    ...
                    <button type="submit" className="btn btn-primary py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-teal-500 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add</button>
                </div>
            </form>
        </div>
    </div>
